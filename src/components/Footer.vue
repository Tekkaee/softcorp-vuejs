  ...
  <footer class="footer">
    <div class="container footer__container">
          ...
          <li class="footer__item">
            ...
            >
              ...
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M13.073 8.422V12.585L5.45212 17.7335L15.0874 14.6246V8.422H13.073Z"
                fill="black"
                fill-opacity="0.2"
              />
              <path
      ...
      <div class="footer__group">
        <ul class="footer__list">
          <li>
            <a class="footer__item" href="mailto:info@ipsum228.com">
              <svg
                class="footer__icon"
                viewBox="0 0 21 20"
                fill="none"
          ...
          <li>
            <a class="footer__item" href="https://vk.com" target="_blank">
              <svg
                class="footer__icon"
                viewBox="0 0 21 20"
                fill="none"
